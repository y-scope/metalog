...
public class FileRecordBuilder {
  ...
  public FileRecord build() {
    ...
    file.setIntAgg("agg_int/gte/level/debug", countLevelDebugPlus);
    file.setIntAgg("agg_int/gte/level/info", countLevelInfoPlus);
    file.setIntAgg("agg_int/gte/level/warn", countLevelWarnPlus);
    file.setIntAgg("agg_int/gte/level/error", countLevelErrorPlus);
    file.setIntAgg("agg_int/gte/level/fatal", countLevelFatalPlus);
