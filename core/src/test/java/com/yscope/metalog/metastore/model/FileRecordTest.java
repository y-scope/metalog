...
class FileRecordTest {
  ...
  void testSetFloatCount_getReturnsValue() {
    FileRecord file = new FileRecord();
    file.setFloatAgg("agg_float_latency_avg", 1.23);

    assertEquals(1.23, file.getFloatAgg("agg_float_latency_avg"));
  }
  ...
  void testGetFloatCount_notSet_returnsNull() {
    ...
    assertNull(file.getFloatAgg("agg_float_latency_avg"));
  }
  ...
  void testSetFloatCount_nan_throws() {
    ...
    assertThrows(
        ...
        () -> file.setFloatAgg("agg_float_latency_avg", Double.NaN));
  }
  ...
  void testSetFloatCount_infinity_throws() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> file.setFloatAgg("agg_float_latency_avg", Double.POSITIVE_INFINITY));
    assertThrows(
        IllegalArgumentException.class,
        () -> file.setFloatAgg("agg_float_latency_avg", Double.NEGATIVE_INFINITY));
  }

  @Test
  void testGetFloatCounts_unmodifiable() {
    FileRecord file = new FileRecord();
    file.setFloatAgg("agg_float_latency_avg", 1.5);
  ...
  void testSetFloatCounts_bulkPopulatesMap() {
    ...
    assertEquals(1.23, file.getFloatAgg("agg_float_latency_avg"));
    assertEquals(4.56, file.getFloatAgg("agg_float_response_sum"));
  ...
  void testSetFloatCounts_nullIsNoop() {
    FileRecord file = new FileRecord();
    file.setFloatAgg("agg_float_latency_avg", 1.0);
