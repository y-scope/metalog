...
import com.yscope.metalog.coordinator.grpc.proto.StringDimension;
...
class ProtoConverterTest {
  ...
  void testToFileRecord_aggEntry_int_storedAsCompositeKey() {
    ...
    assertEquals(12345L, file.getIntAgg("GTE\0level\0debug"));
  }
  ...
  void testToFileRecord_aggEntry_float_storedAsCompositeKey() {
    ...
    assertEquals(1.5, file.getFloatAgg("AVG\0latency\0p99"));
  }
  ...
  void testToFileRecord_aggEntry_noQualifier_emptyQualifierInKey() {
    ...
    assertEquals(999L, file.getIntAgg("EQ\0record_count\0"));
  }
  ...
  void testParseSelfDescAgg_intNoQualifier_stored() {
    ...
    assertEquals(500L, file.getIntAgg("EQ\0record_count\0"));
  }
  ...
  void testParseSelfDescAgg_floatNoQualifier_stored() {
    ...
    assertEquals(1.5, file.getFloatAgg("AVG\0latency\0"));
  }
  ...
  void testParseSelfDescAgg_floatWithQualifier_stored() {
    ...
    assertEquals(2.5, file.getFloatAgg("AVG\0latency\0p99"));
  }
  ...
  void testToFileRecord_selfDescribingKv_routedCorrectly() {
    ...
    assertEquals(999L, file.getIntAgg("GTE\0level\0debug"));
  }
}
