...
import com.yscope.metalog.common.config.db.JdbcUrlBuilder;
...
public class ServiceConfig {
  ...
  private volatile com.yscope.metalog.common.config.db.DatabaseTypeDetector.DatabaseInfo
  ...
  public String getDatabaseType() {
    if (detectedDatabaseInfo != null) {
      return com.yscope.metalog.common.config.db.DatabaseTypeDetector.toSimpleTypeName(
   ...
   */
  public com.yscope.metalog.common.config.db.DatabaseTypeDetector.DatabaseInfo
  ...
  public void setDetectedDatabaseInfo(
      com.yscope.metalog.common.config.db.DatabaseTypeDetector.DatabaseInfo info) {
  ...
  public String getDatabaseName() {
    return get("db.database", "metalog_metastore");
  }
