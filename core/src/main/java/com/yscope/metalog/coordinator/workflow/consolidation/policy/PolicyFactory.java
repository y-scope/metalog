...
import com.yscope.metalog.coordinator.workflow.consolidation.policy.PolicyConfig.PolicyDefinition;
...
public class PolicyFactory {
  ...
  private static final String DEFAULT_POLICY_PACKAGE =
      "com.yscope.metalog.coordinator.workflow.consolidation.policy";
