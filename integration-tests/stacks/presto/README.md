...
Presto CLP connector against a live Metalog with realistic metadata.
...
Go build. The first `./start.sh` run compiles the full project and takes
1–2 minutes. Subsequent runs reuse the Docker layer cache.
