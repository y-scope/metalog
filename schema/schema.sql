...
--    and remains immutable. All messages for the same IR path must use the same
...
-- ============================================================================
--
-- Split into identity, feature config, and node assignment.
...
--                     consolidation policies, and all other per-table operational
--                     parameters. Read-heavy, hot-reloaded
...
-- NULL blob → all defaults (consolidation.enabled=true, retention.type="default").
...
--
-- Recovery:
--   On coordinator restart, tasks are deleted and the coordinator resumes
--   processing from the last committed state.
--
