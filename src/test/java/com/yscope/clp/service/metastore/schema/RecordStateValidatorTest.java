...
class RecordStateValidatorTest {
  ...
  class CountHierarchy {
    ...
    void validCountHierarchy_passes() {
      ...
      file.setCount("agg_int/gte/level/debug", 80);
      file.setCount("agg_int/gte/level/info", 60);
      file.setCount("agg_int/gte/level/warn", 40);
      file.setCount("agg_int/gte/level/error", 20);
      file.setCount("agg_int/gte/level/fatal", 5);
    ...
    void recordCountLessThanDebug_returnsError() {
      ...
      file.setCount("agg_int/gte/level/debug", 80); // More than record_count
    ...
    void debugLessThanInfo_returnsError() {
      FileRecord file = createValidIrClosedFile();
      file.setRecordCount(100);
      file.setCount("agg_int/gte/level/debug", 30);
      file.setCount("agg_int/gte/level/info", 50); // More than debug
    ...
    void fullHierarchyViolation_detected() {
      ...
      file.setCount("agg_int/gte/level/debug", 20);
      file.setCount("agg_int/gte/level/info", 30);
      file.setCount("agg_int/gte/level/warn", 40);
      file.setCount("agg_int/gte/level/error", 50);
      file.setCount("agg_int/gte/level/fatal", 60);
