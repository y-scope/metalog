...
class MetadataGrpcServiceTest {
  ...
  class ListAggs {
    ...
    void returnsAggDetails() {
      ...
      assertEquals(
          com.yscope.clp.service.query.api.proto.grpc.AggregationType.AGGREGATION_TYPE_GTE,
          aggs.get(0).getAggregationType());
      assertEquals(
          com.yscope.clp.service.query.api.proto.grpc.AggValueType.AGG_VALUE_TYPE_INT,
