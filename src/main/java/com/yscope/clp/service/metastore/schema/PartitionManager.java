...
public class PartitionManager {
  ...
  /**
   * @deprecated Use {@link #PartitionManager(DSLContext, String, int, int, long)} instead.
   */
  @Deprecated
  public PartitionManager(
  ...
  /**
   * @deprecated Use {@link #PartitionManager(DSLContext, ServiceConfig)} instead.
   */
  @Deprecated
  public PartitionManager(DataSource dataSource, ServiceConfig config) {
    this(DSLContextFactory.create(dataSource), config);
  }
