...
public class RecordStateValidator {
  ...
  private void validateCountHierarchy(FileRecord file, ValidationResult result) {
    ...
    long debugPlus = file.getCountOrZero(Columns.AGG_INT_GTE_LEVEL_DEBUG);
    long infoPlus = file.getCountOrZero(Columns.AGG_INT_GTE_LEVEL_INFO);
    long warnPlus = file.getCountOrZero(Columns.AGG_INT_GTE_LEVEL_WARN);
    long errorPlus = file.getCountOrZero(Columns.AGG_INT_GTE_LEVEL_ERROR);
    long fatalPlus = file.getCountOrZero(Columns.AGG_INT_GTE_LEVEL_FATAL);
