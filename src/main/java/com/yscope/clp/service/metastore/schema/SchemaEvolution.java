...
import com.yscope.clp.service.metastore.schema.BaseSchemaValidator.SchemaValidationException;
import java.sql.*;
...
public class SchemaEvolution {
  ...
  /**
   * @deprecated Use constructor accepting DSLContext instead.
   */
  @Deprecated
  public SchemaEvolution(
      DataSource dataSource, String tableName, boolean enabled, ColumnRegistry columnRegistry)
      throws SchemaValidationException, SQLException {
    this(
        dataSource != null
            ? com.yscope.clp.service.common.config.db.DSLContextFactory.create(dataSource)
            : null,
        tableName,
        enabled,
        columnRegistry);
