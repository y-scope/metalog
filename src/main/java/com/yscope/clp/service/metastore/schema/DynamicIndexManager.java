...
public class DynamicIndexManager {
  ...
  /**
   * @deprecated Use {@link #DynamicIndexManager(DSLContext, String)} instead.
   */
  @Deprecated
  public DynamicIndexManager(DataSource dataSource, String tableName) {
    this(DSLContextFactory.create(dataSource), tableName);
  }
