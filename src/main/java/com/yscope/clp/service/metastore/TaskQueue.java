...
public class TaskQueue {
  ...
  /**
   * @deprecated Use {@link #TaskQueue(DSLContext)} instead.
   */
  @Deprecated
  public TaskQueue(DataSource dataSource) {
    this(com.yscope.clp.service.common.config.db.DSLContextFactory.create(dataSource));
  }
