...
/** Consumes metadata messages from Kafka and writes to MySQL. */
public class MetadataConsumer {
  ...
  /**
   * Poll for messages and return parsed IR files. Each FileRecord will have its sourceOffset set to
  ...
  /**
   * Get the last polled offsets per partition. Useful for debugging and monitoring watermark
   * progress.
   *
   * @return Map of partition to last polled offset
   */
  public Map<TopicPartition, Long> getLastPolledOffsets() {
