...
public class StorageBackendFactory {
  ...
  private static final String DEFAULT_STORAGE_PACKAGE = "com.yscope.clp.service.common.storage";
   ...
   * @return fully constructed StorageRegistry
   * @deprecated Use {@link #createRegistry(String, Map)} instead for generic backend support
   */
  @Deprecated
