package com.yscope.clp.service.query.core;
...
import com.yscope.clp.service.query.core.splits.NoOpSketchEvaluator;
...
public class QueryService {
  ...
  public QueryService(ApiServerConfig.DataSourceConfig config, CacheService cacheService) {
    ...
    this.registryProvider = new ColumnRegistryProvider(dataSource);
  ...
  public record AggDetail(
      String name,
      String value,
      com.yscope.clp.service.metastore.model.AggregationType aggregationType,
      com.yscope.clp.service.metastore.model.AggValueType valueType,
      String aliasColumn) {}
