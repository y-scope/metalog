...
message Split {
    ...
    map<string, string> dimensions = 2;   // __DIM.* fields (logical key → value)
...
message QueryStats {
  ...
  bool  truncated      = 3;   // true when more results exist beyond the requested limit
}
```
