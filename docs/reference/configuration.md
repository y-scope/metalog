...
node:
  ...
  # Unified gRPC server (used by ServerMain in grpc-server module).
  # NodeMain (headless) ignores this — it runs no gRPC servers.
  # grpc:
  #   enabled: true
  #   port: 9090
  #   services:
  #     ingestion: true    # MetadataIngestionService
  #     query: true        # QuerySplitsService
  #     catalog: true      # MetadataService
  #     admin: true        # CoordinatorService
...
| `DB_JDBC_URL` | `jdbc:mariadb://localhost:3306/metalog_metastore` | Read replica JDBC URL |
