...
4. Start Thread 1: Kafka Poller (if enabled)
5. Start Thread 3: Planner (if consolidation enabled)
6. Start Thread 4: Storage Deletion (if deletion enabled and storage configured)
7. Start Thread 5: Retention Cleanup (if enabled)
8. Ready to process
...
2. Stop Thread 1: Kafka Poller
3. Stop Thread 3: Planner
4. Stop Thread 4: Storage Deletion
5. Stop Thread 5: Retention Cleanup
