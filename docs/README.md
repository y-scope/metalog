...
- [Architecture Overview](concepts/overview.md) — System overview, data lifecycle, thread model, components
...
- [Performance Tuning](operations/performance-tuning.md) — Benchmarks, JDBC gotchas, index strategy
