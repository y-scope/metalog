...
Daily partitions are created automatically by the Partition Maintenance goroutine (runs hourly, creates `partition.lookahead.days` days ahead). No manual partition management is needed.
