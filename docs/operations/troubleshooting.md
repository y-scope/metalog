...
**Symptom:**
```
ERROR Node - Failed to initialize schema: Table 'clp_metastore.clp_spark' doesn't exist
```
...
- Check for leftover partial schema from a previous failed run: `SHOW TABLES IN clp_metastore`.
